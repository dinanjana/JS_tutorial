...
*/
	View.prototype={
		renderView :function(controller,fn2){
		...
		renderInputField:function(controller,fn1){
			var container = document.getElementById('input');
			container.appendChild(this.createTaskTextField(controller,fn1));
		},

		renderFilteredView: function(controller,list,completed,fn){
		...
		renderTaskInputField:function(controller,fn1){
			var container = document.getElementById('container');
			container.appendChild(this.createTaskTextField(controller,fn1));
		},

		createView:(controller,fn2)=>{
			let elem =document.createElement('div');
			let elem1=document.createElement('ul');
		...
		createTaskTextField:function(controller,taskSubmitAction){
		...
		renderFilterButtons:function(controller,filterAction){
